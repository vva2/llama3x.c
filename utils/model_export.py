...
Among the "input" versions of PyTorch files/assets:
- Official Llama 2 weights released by Meta
- Huggingface weights available on the hub
- llama2.c (this repo) trained assets
...
def hf_export(llama_model, filepath, group_size=64, dtype=torch.float32):
    ...
    try:
        ...
        print("Error: transformers package is required to load huggingface assets")
    ...
    # Generate LlamaConfig (seen in transformers.assets.llama.configuration_llama)
...
if __name__ == "__main__":
    ...
    parser.add_argument("filepath", type=str, help="the output filepath", default="temp.bin")
    parser.add_argument(
